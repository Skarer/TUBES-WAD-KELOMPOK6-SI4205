...
<div class="row ml-4">
    <h3 style="margin-left: 10px;">Edit Kegiatan</h3>
</div>
...
<div class="row mx-auto mt-3">
    ...
    <div class="col">
        <div class="card h-100">
            ...
            <div class="card-body">
                <form action="/homeguru/edit/{{$event->id}}/update" method="POST">
                @method('patch')
                @CSRF 
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="Deskripsi" rows="3" name="deskripsi" value="{{$event->deskripsi}}"></textarea>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input class="form-control" type="date" id="example-date-input" name="tanggal" value="{{$event->tanggal}}">
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control" name="jam_berakhir" value="{{$event->jam_berakhir}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="tempat"><strong>Tempat</strong></label>
                    <input type="text" class="form-control" id="tempat" placeholder="Tempat" name="tempat"value="{{$event->tempat}}">
                </div>
                <br>
