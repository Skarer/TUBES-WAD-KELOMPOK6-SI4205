...
<!--buat nama title webnya -->
    ...
    @section('content')            
                    ...
                    <div class="card-body">
                    <form class="row g-3" action="/pelajaran/create/store" method="POST" enctype="multipart/form-data">
                    @CSRF 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control" id="akhir" name="jam_selesai">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="kelas" name="kelas" placeholder="angkatan-kelas">
                    </div>
                    ...
                    <div class="card-footer">
                     <button type="submit" class="btn btn-primary text-center" style="width:10rem; margin-left:130px" id="submit" name="input">Input</button>
                    </div>
                    </form>
                </div>
