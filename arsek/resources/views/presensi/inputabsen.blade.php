    ...
    <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-sm-5" >
                             <div class="card border-light" >
                                ...
                                <form action="/absen/create/store " method="POST" enctype="multipart/form-data">
                                    @CSRF 
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kelas" name="kelas" placeholder="angkatan-kelas"required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="tanggal" class="form-label">Tanggal Kehadiran</label>
                                        <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="angkatan-kelas"required>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-primary" id="submit" name="submit" style="margin-left:14rem;">Submit</button>
                                </div> 
                                </form>
                            </div>
