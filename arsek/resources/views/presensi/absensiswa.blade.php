...
<!--buat nama title webnya -->
    ...
    <br>
        ...
        <div class="col">
            <a type="button" class="btn btn-success" style="margin-left:350px;" href="/absen/create">Tambah Data</a>
        </div>
    </div>
        <div class = "container">
                ...
                <table style= "text-align: center; margin-top:30px;" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <td><a href="/absen/edit/{{$attedance->id}}" class="btn btn-primary">Edit</a>
